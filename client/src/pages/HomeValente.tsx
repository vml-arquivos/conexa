// ========================================
// SISTEMA VALENTE - Landing Page Institucional
// Rota: /
// Design: Limpo, afetivo, profissional
// ========================================
...
export default function HomeValente() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-rose-50">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md shadow-sm z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-rose-600 rounded-lg flex items-center justify-center">
              <Heart className="w-6 h-6 text-white" fill="currentColor" />
            </div>
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-rose-600 bg-clip-text text-transparent">
                VALENTE
              </h1>
              <p className="text-xs text-gray-600">Sistema CoCris</p>
            </div>
          </div>
          
          <Link href="/login">
            <button className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-rose-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300 flex items-center gap-2">
              Área do Colaborador
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              O <strong>VALENTE</strong> é o sistema que cuida de quem cuida. 
              Gestão inteligente para a rede CoCris, focada em dignidade humana, 
              proteção à criança e automatização de burocracia.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Link href="/login">
                <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-rose-600 text-white rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
                  Acessar Sistema
                </button>
              </Link>
      ...
      <section id="sobre" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Proteção à Criança */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-rose-50 to-rose-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                Monitoramento inteligente do desenvolvimento, alertas precoces 
                e acompanhamento psicológico quando necessário.
              </p>
            </div>
            
            {/* Qualidade Pedagógica */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    IA mentora que sugere atividades BNCC personalizadas e <strong>detecta precocemente</strong> 
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start gap-6">
                <div className="w-16 h-16 bg-gradient-to-br from-rose-600 to-rose-700 rounded-xl flex items-center justify-center flex-shrink-0">
      ...
      {/* CTA SECTION */}
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 via-purple-600 to-rose-600">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold">VALENTE</h3>
                <p className="text-sm text-gray-400">Sistema CoCris v1.0</p>
              </div>
            </div>
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Tecnologia que transforma, educação que inspira
              </p>
            </div>
          </div>
        </div>
